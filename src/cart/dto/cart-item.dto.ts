...
class CartSeminarDto {
  ...
  @ApiProperty({ type: () => CartSeminarLecturerDto })
  lecturer!: CartSeminarLecturerDto;

  @ApiProperty({ type: () => CartSeminarFormatDto })
  format!: CartSeminarFormatDto;
}
...
export class CartItemDto {
  ...
  @ApiProperty({ type: () => CartSeminarDto })
  seminar!: CartSeminarDto;
